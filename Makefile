VIMSCRIPT_VERSION := $(shell cat VIMSCRIPT_VERSION)
VIMSCRIPT_DEPS := $(wildcard VIMSCRIPT_*) run_vim
DOCKER_TAG_PREFIX := rzuckerm/vimscript:$(VIMSCRIPT_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(VIMSCRIPT_DEPS)
